...
class _TransaksiFormState extends State<TransaksiForm> {
  var totalBayar = 0.0;
  var jumlahBeli = 0.0;
  var hargaBarang = TransaksiScreens.dataMakeup['harga'];

  Response? response;
  var dio = Dio();
  @override
  Widget build(BuildContext context) {
    print(TransaksiScreens.dataMakeup);
    return Form(
        child: Column(
      children: [
        Image.network(
          "$baseUrl/${TransaksiScreens.dataMakeup['gambar']}",
          width: 250,
          height: 250,
          fit: BoxFit.cover,
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "${TransaksiScreens.dataMakeup['nama']}",
              )
            ],
          ),
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "${TransaksiScreens.dataMakeup['tipe']}",
              )
            ],
          ),
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "${TransaksiScreens.dataMakeup['harga']}",
              )
            ],
          ),
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "${TransaksiScreens.dataMakeup['merk']}",
              )
            ],
          ),
        ),
          ...
          press: () {
            if (totalBayar <= 0 || jumlahBeli <= 0) {
              ...
              AwesomeDialog(
                      ...
                      title: 'Peringatan',
                      desc:
                          'Yakin ingin melakukan pembelian makeup ${TransaksiScreens.dataMakeup['nama']} ?....',
                      btnOkOnPress: () {
                        prosesTransaksi(
                            TransaksiScreens.dataMakeup['_id'],
