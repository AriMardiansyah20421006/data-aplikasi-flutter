                ...
                Container(
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return cardDataMakeup(dataMakeup[index]);
                    },
                  ),
                )
              ],
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          subtitle: Row(children: [
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, EditMakeupScreens.routeName,
                    arguments: data);
              },
              child: Row(children: [
                Icon(
